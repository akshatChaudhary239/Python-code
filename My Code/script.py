...
# person1.update(new item) we can add any new value in our dictionary
...
# crrate a class that takes names and marks of 3 students and also create a method to print the average
